...
if args.resume:
    ...
    assert os.path.isdir('checkpoint2'), 'Error: no checkpoint directory found!'
    checkpoint = torch.load('./checkpoint2/vgg3.pth')
...
writer = SummaryWriter('logs1/vgg3')
...
def test(epoch):
    ...
    if acc > best_acc:
        ...
        torch.save(state, './checkpoint2/vgg3.pth')
        best_acc = acc
